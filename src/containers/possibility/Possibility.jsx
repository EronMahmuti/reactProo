...
export const Possibility = () => {
    ...
    return (
        <div className="gpt3__possibility section__padding" id="possibility" >
                <div className="gpt3__possibility-image" data-aos="fade-up" data-aos-easing="linear" >
                    <img src={possibilityImage} alt="possibilty" />
                </div>
                <div className="gpt3__possibility-content" data-aos="fade-up" data-aos-easing="linear" >
